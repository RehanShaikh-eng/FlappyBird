Flappy Bird 🐦 🎮 This is a Flappy Bird built using Java Swing. The game features a simple 2D UI, where the player controls a bird and navigates through obstacles by pressing the spacebar to flap.
